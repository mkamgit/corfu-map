...
Στη συνέχεια ακολουθήστε τα βήματα που αντιστοιχούν στα παραδοτέα αυτής της εργασίας (βλ. σχετικά ανοικτά [issues](https://github.com/ioniodi/corfu-map/issues)) βάσει των [γενικών οδηγιών εκπόνησης των εργασιών](https://github.com/courses-ionio/projects/blob/master/README.md).
